...
export default function About() {
  return (
    <div
      className="relative w-[100%] md:w-[90%] mx-auto my-5 flex flex-col p-3 gap-10"
      id="about"
    >
      <h1
      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-0 justify-between w-[100%]">
        ...
        >
          <div className="flex flex-col gap-5 md:gap-10 ml-2 md:ml-5">
            <p className="text-[15px] md:text-lg text-left">
            ...
            >
              <p className="text-lg md:text-3xl">I'm</p>
              <span className="text-[12px] md:text-[20px] text-white bg-black w-fit h-fit px-2 py-0 md:py-1 md:px-1 ">
                <Typewriter
                  options={{
                    loop: true,
